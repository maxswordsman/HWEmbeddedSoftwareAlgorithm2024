...
//寻找路径变量
int vis[15005],fa[85][15005][2],dis[15005],cha_find,min_dis_find;
//加边变量
int dis_add[15005],vis_add[15005],min_dis=1e9,cha_add;
    ...
    for(int j=0;j<P;j++){
        ...
        while(!q.empty()){
            ...
            for(int i=head[x];i;i=p[i].next){
                if(dis[p[i].to]>dis[x]+p[i].v+w*num_channel[p[i].i]&&channel[p[i].i][j]==0){
